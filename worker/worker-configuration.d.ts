/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d6bcf6c3ebfc84f8a96de3af835a83e9)
// Runtime types generated with workerd@1.20250823.0 2025-08-31 
declare namespace Cloudflare {
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_TURNSTILE_SECRET: string;
		CLOUDFLARE_TURNSTILE_SITE: string;
		COUNTER_TRACKER: DurableObjectNamespace<import("./src/index").CounterTracker>;
		RATELIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
	}
}
