/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 4b8aa4d044d6ef498ff6b62d5112091e)
// Runtime types generated with workerd@1.20250823.0 2025-08-31 nodejs_als
declare namespace Cloudflare {
	interface Env {
		COUNTER_TRACKER: DurableObjectNamespace /* CounterTracker from ./src/CounterTracker.ts */;
		RATELIMITER: DurableObjectNamespace /* RateLimiter from ./src/RateLimiter.ts */;
		ASSETS: Fetcher;
	}
}
